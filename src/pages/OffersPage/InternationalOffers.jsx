...
const InternationalOffers = () => {
  ...
  useEffect(()=>{
    const fetchInternationalOffersData = async()=>{
      ...
      try {
        const response = await axiosInstance.get('/inquiry-approved-international-offers',{
          headers: {
        ...
        if (response && response.data) {
          ...
          console.error("Failed to fetch international offers", response.status);
        }

      } catch (error) {
        console.error("Error fetching international offers:", error);
      }
    };
...
export default InternationalOffers;
