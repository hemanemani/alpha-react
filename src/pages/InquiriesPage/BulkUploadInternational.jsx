...
const BulkUploadInternational = () => {
    ...
    const fetchInquiryData = async () => {
        ...
        try {
          const response = await axiosInstance.get("/bulk-international-data", {
            headers: {
    ...
    const handleDownload = async () => {
        ...
        try {
          ...
          link.download = 'international-template.xlsx'; // Specify the default filename
    ...
    return(
        ...
        <InternationalUploadData rows={rows} setRows={setRows} filteredRows={filteredRows} setFilteredRows={setFilteredRows} />
        </>
    )
}
